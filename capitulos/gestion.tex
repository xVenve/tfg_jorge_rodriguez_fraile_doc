...
\section{Presupuesto}
En esta sección se recopilará y explicará todos los gastos que se han generado durante el tiempo de desarrollo de este proyecto. \\ Cada una de las siguientes subsecciones tratará sobre una de las fuentes de costes y la última será un resumen de estos, donde se expondrá el presupuesto total de la realización del trabajo.
