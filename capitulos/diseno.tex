...
\begin{figure}[H]
	...
	{\caption{Interfaz de inicio de sesión}
		\label{fig:iLogin}}
	{\includegraphics[scale=0.28]{login.png}}
\end{figure}
...
\begin{figure}[H]
	...
	{\includegraphics[scale=0.28]{devices.png}}
\end{figure}
...
\begin{figure}[H]
	...
	{\includegraphics[scale=0.28]{medidas1.png}}
\end{figure}
...
\begin{figure}[H]
	...
	{\includegraphics[scale=0.28]{medidas2.png}}
\end{figure}
...
\begin{figure}[H]
	...
	{\includegraphics[scale=0.28]{medidas3.png}}
\end{figure}
...
En cuanto a la cámara se usa la Raspberry Pi Camera, más específicamente la \textbf{Ov5647}, que se conecta mediante el puerto CSI directamente a la Raspberry Pi. Esta será la encarga de captar la imagen de la sala CPD en la que se encuentre instalado el dispositivo.
